...
const CourseCard = ({ cardData, currentCard, setCurrentCard }) => {
    return (
      <>
        <div className="flex flex-col  items-start gap-12 self-auto bg-white text-black">
          {/* <div className="absolute max-w-sm p-6 bg-yellow-200 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"></div> */}
          <div className="flex flex-col gap-4 px-4 py-2 mb-4 ">
            <h2 className="font-bold text-xl ">HTML</h2>
            <p className="text-start text-richblack-400">
          ...
          <div className="flex flex-row justify-between w-full py-3 px-4 border-t border-dashed">
            ...
            <div className="flex flex-row gap-4 text-richblack-400 items-center text-[16px] hover:text-blue-200">
              {/* <FcFlowChart /> */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="19"
