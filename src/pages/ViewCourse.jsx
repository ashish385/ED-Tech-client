...
import { setCompletedLecture, setCourseEntireData, setCourseSectionData, setTotalNoOfLecture } from '../redux/slices/viewCourseSlice';
...
const ViewCourse = () => {
    ...
    useEffect(() => {
        const setCourseSepecificDetails = async () => {
